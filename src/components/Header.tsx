  ...
  return (
    <header className="bg-white dark:bg-gray-950 shadow-sm border-b dark:border-gray-800">
      <div className="pt-container">
              ...
              return (
                <Link
                  ...
                  className={`inline-flex items-center px-1 pt-1 text-sm font-medium transition-colors ${
                    isActive
                      ? 'text-pt-blue dark:text-pt-green border-b-2 border-pt-green'
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-white dark:bg-gray-950 border-t dark:border-gray-800">
              {navigation.map((item) => {
                const Icon = item.icon;
                const isActive = location.pathname === item.href;
                return (
                  <Link
                    ...
                    className={`block px-3 py-2 text-base font-medium transition-colors ${
                      isActive
                        ? 'text-pt-blue dark:text-pt-green bg-pt-green/10 dark:bg-pt-green/20'
                        : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'
                    }`}
